# Add different protocol templates to use e.g.
# NTP
# HTTP + SSL
# FTP + SSL
# SSH
...
# Implement a DDoS generator (NTP AMPING, PING SPAM, all that good shit)
# Implement some MiTMAs
# Create a nice optional nice fancy ass CUInterface
# Add a logger
...
class sockcli(): # SOCKCLI class that contains all the functions (this can be imported by other .py script applications)
    ...
    def Connect(self): # Function to connect to specified HOST and PORT
...
if(__name__ == "__main__"):
    ...
    while(True):
        ...
        #if(COMMAND[0].lowercase() == "cui"):
        #    
        #    cprint("Entering fancyverse!")
        #    
        #    # Redefine cprint() function
        #    # Only use f"{}" for string interpoling when cprint()ing
